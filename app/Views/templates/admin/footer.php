                ...
                <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                    <span class="mr-2">
                        <span class="rounded-circle profile-image d-block"
                            style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-d.png'); background-size: cover;"></span>
                    </span>
                            ...
                            <ul id="js-msgr-listfilter" class="list-unstyled m-0">
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle status status-success status-sm ">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-b.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                Oliver Kopyuv
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle status status-warning status-sm ">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-e.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                Dr. John Cook PhD
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle status status-success status-sm ">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-g.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                Ali Amdaney
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle status status-success status-sm">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-h.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                Sarah McBrook
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle status status-sm">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-a.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle status status-danger status-sm">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-j.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                oliver.kopyuv@gotbootstrap.com
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle status status-sm">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-c.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                oliver.kopyuv@gotbootstrap.com
                                ...
                                <li>
                                    <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                        ...
                                        <div class="d-table-cell align-middle">
                                            <span class="profile-image-md rounded-circle d-block"
                                                style="background-image:url('assets/libraries/smartadmin/img/demo/avatars/avatar-m.png'); background-size: cover;"></span>
                                        </div>
                                        <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                            <div class="text-truncate text-truncate-md">
                                                +714651347790
                        ...
                        <ul class="m-0">
                            ...
                            <li>
                                <a href="#" id="myapp-1" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-1.css"
                            ...
                            <li>
                                <a href="#" id="myapp-2" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-2.css"
                            ...
                            <li>
                                <a href="#" id="myapp-3" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-3.css"
                            ...
                            <li>
                                <a href="#" id="myapp-4" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-4.css"
                            ...
                            <li>
                                <a href="#" id="myapp-5" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-5.css"
                            ...
                            <li>
                                <a href="#" id="myapp-6" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-6.css"
                            ...
                            <li>
                                <a href="#" id="myapp-7" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-7.css"
                            ...
                            <li>
                                <a href="#" id="myapp-8" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-8.css"
                            ...
                            <li>
                                <a href="#" id="myapp-9" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-9.css"
                            ...
                            <li>
                                <a href="#" id="myapp-10" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-10.css"
                            ...
                            <li>
                                <a href="#" id="myapp-11" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-11.css"
                            ...
                            <li>
                                <a href="#" id="myapp-12" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-12.css"
                            ...
                            <li>
                                <a href="#" id="myapp-13" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-13.css"
                            ...
                            <li>
                                <a href="#" id="myapp-14" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-14.css"
                            ...
                            <li>
                                <a href="#" id="myapp-15" data-action="theme-update" data-themesave
                                    data-theme="/assets/libraries/smartadmin/css/themes/cust-theme-15.css"
